...
const Home = ({ onTextBoxHover, onTextBoxLeave }) => {
    ...
    const THEME_OPTIONS = [
        { name: 'Dark', title: 'Dark', vars: { '--bg-color': '#0f172a', '--text-color': '#e2e8f0', '--accent-color': '#6366f1', '--panel-bg': 'rgba(255,255,255,0.06)', '--border-color': 'rgba(255,255,255,0.12)' }, previewBg: '#0f172a', previewTextColor: '#e2e8f0' },
        { name: 'Light', title: 'Light', vars: { '--bg-color': '#f8fafc', '--text-color': '#0f172a', '--accent-color': '#4f46e5', '--panel-bg': 'rgba(0,0,0,0.06)', '--border-color': 'rgba(0,0,0,0.12)' }, previewBg: '#f8fafc', previewTextColor: '#0f172a' },
        { name: 'OLED', title: 'OLED', vars: { '--bg-color': '#000000', '--text-color': '#ffffff', '--accent-color': '#10b981', '--panel-bg': 'rgba(255,255,255,0.06)', '--border-color': 'rgba(255,255,255,0.25)' }, previewBg: '#000000', previewTextColor: '#ffffff' },
        { name: 'Midnight', title: 'Midnight Purple', vars: { '--bg-color': '#0b0b17', '--text-color': '#e9d5ff', '--accent-color': '#9b59f5', '--panel-bg': 'rgba(155,89,245,0.08)', '--border-color': 'rgba(155,89,245,0.3)' }, previewBg: '#0b0b17', previewTextColor: '#e9d5ff' },
        { name: 'Ocean', title: 'Ocean Blue', vars: { '--bg-color': '#071924', '--text-color': '#d1f4ff', '--accent-color': '#22d3ee', '--panel-bg': 'rgba(34,211,238,0.08)', '--border-color': 'rgba(34,211,238,0.3)' }, previewBg: '#071924', previewTextColor: '#d1f4ff' },
        { name: 'Solarized', title: 'Solarized Dark', vars: { '--bg-color': '#002b36', '--text-color': '#93a1a1', '--accent-color': '#b58900', '--panel-bg': 'rgba(147,161,161,0.08)', '--border-color': 'rgba(147,161,161,0.25)' }, previewBg: '#002b36', previewTextColor: '#93a1a1' },
        { name: 'HighContrast', title: 'High Contrast', vars: { '--bg-color': '#000000', '--text-color': '#ffffff', '--accent-color': '#ffcc00', '--panel-bg': 'rgba(255,255,255,0.12)', '--border-color': 'rgba(255,255,255,0.45)' }, previewBg: '#000000', previewTextColor: '#ffffff' },
        { name: 'Forest', title: 'Forest', vars: { '--bg-color': '#0b1f15', '--text-color': '#d3f9d8', '--accent-color': '#22c55e', '--panel-bg': 'rgba(34,197,94,0.08)', '--border-color': 'rgba(34,197,94,0.3)' }, previewBg: '#0b1f15', previewTextColor: '#d3f9d8' },
        { name: 'Sunset', title: 'Sunset', vars: { '--bg-color': '#1a0e0e', '--text-color': '#ffd7c2', '--accent-color': '#fb7185', '--panel-bg': 'rgba(251,113,133,0.08)', '--border-color': 'rgba(251,113,133,0.3)' }, previewBg: '#1a0e0e', previewTextColor: '#ffd7c2' },
        { name: 'Neon', title: 'Neon', vars: { '--bg-color': '#0a0a0f', '--text-color': '#eaffff', '--accent-color': '#00f0ff', '--panel-bg': 'rgba(0,240,255,0.12)', '--border-color': 'rgba(0,240,255,0.3)' }, previewBg: '#0a0a0f', previewTextColor: '#eaffff' },
        { name: 'Monochrome', title: 'Monochrome', vars: { '--bg-color': '#111111', '--text-color': '#f5f5f5', '--accent-color': '#9e9e9e', '--panel-bg': 'rgba(255,255,255,0.12)', '--border-color': 'rgba(255,255,255,0.2)' }, previewBg: '#111111', previewTextColor: '#f5f5f5' },
        { name: 'Material', title: 'Material', vars: { '--bg-color': '#0b1021', '--text-color': '#e2e8f0', '--accent-color': '#3b82f6', '--panel-bg': 'rgba(59,130,246,0.12)', '--border-color': 'rgba(59,130,246,0.25)' }, previewBg: '#0b1021', previewTextColor: '#e2e8f0' },
        { name: 'Pastel', title: 'Pastel', vars: { '--bg-color': '#101317', '--text-color': '#e6f1ff', '--accent-color': '#a5b4fc', '--panel-bg': 'rgba(165,180,252,0.12)', '--border-color': 'rgba(165,180,252,0.3)' }, previewBg: '#101317', previewTextColor: '#e6f1ff' }
    ];
